...
- matches the expected response shape with `Build Goal`, `Supporting Species Legality`, `Recommended Team`, `Role Map`, `Set Direction`, `Why Each Slot Exists`, `Matchup Notes`, and `Weaknesses and Next Refinements`
